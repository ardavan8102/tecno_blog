...
class ArticleSingleManagementPage extends StatelessWidget {
  ...
  final FilePickController filePickController = Get.find<FilePickController>();
                ...
                Stack(
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: filePickController.file.value.name == 'nothing'
                      ? CachedNetworkImage(
                        ...
                        errorWidget: (context, url, error) => Image.network(AppAssets.networkPlaceholderAsset, fit: .cover),
                      ) : Image.file(
                        File(filePickController.file.value.path!),
                        fit: .cover,
                      ),
                    ),
                    ...
                    Positioned(
                      ...
                      right: size.width * .2,
                      left: size.width * .2,
                      child: ChooseImageForArticleButton(),
                    ),
                  ],
                ),
